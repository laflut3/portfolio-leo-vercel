        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, db.insert(schema_1.actualSituationTable).values({ content: actualSituationContent })];
                case 1:
                    _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error inserting actual situation:', error_1);
                    return [3 /*break*/, 4];
                case 3:
                    client.close();
                    return [7 /*endfinally*/];
