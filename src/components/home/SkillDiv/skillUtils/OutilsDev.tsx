...
import CICD from "../../../../../public/assets/image/logoDev/outilsDev/CICD.png";
import postman from "../../../../../public/assets/image/logoDev/outilsDev/postman.png";
...
export default function OutilsDevDiv() {
    return (
        <div className={"flex flex-wrap justify-center items-center gap-4 w-full"}>
            ...
            <Image className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 object-contain" src={postman} alt="postman"/>
            <Image className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 object-contain" src={CICD} alt="CICD"/>
